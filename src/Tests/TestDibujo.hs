...
-- por alguna razon, la vida es cruel y solo se pueden corren los tests comentando 
-- lo del mudulo de dibujos, no se porque, pero bueno, asi es la vida 
-- eso ultimo lo escribio el copilot
